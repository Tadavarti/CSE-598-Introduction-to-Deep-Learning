class Module:
    ...
    def named_parameters(self):
        ...
        for na , mod in self._modules.items():
            child_par = mod.named_parameters()
            for k , v in child_par:
                new_k = f"{na}.{k}"
                input_parameters[new_k] = v
        # return input_parameters
        t = []
        for a in input_parameters:
            t.append((a , input_parameters[a]))
        return (t)
        raise NotImplementedError('Need to implement for Task 0.4')
    ...
    def parameters(self):
        ...
        # TODO: Implement for Task 0.4.
        output = []
        for val in self.named_parameters():
            output.append(val[1])
        return output
