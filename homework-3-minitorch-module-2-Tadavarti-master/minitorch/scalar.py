...
class Log(ScalarFunction):
    ...
    def backward(ctx, d_output):
        a = ctx.saved_values
        return operators.log_back(a, d_output) , d_output
...
class Inv(ScalarFunction):
    ...
    def backward(ctx, d_output):
        # TODO: Implement for Task 1.4.
        a = ctx.saved_values
        return (operators.inv_back(a, d_output) , d_output)
        raise NotImplementedError('Need to implement for Task 1.4')
...
class Sigmoid(ScalarFunction):
    ...
    def backward(ctx, d_output):
        # TODO: Implement for Task 1.4.
        a = ctx.saved_values
        return(operators.sigmoid(a) * (1 - operators.sigmoid(a)) * d_output , d_output)
        raise NotImplementedError('Need to implement for Task 1.4')
...
class ReLU(ScalarFunction):
    ...
    def backward(ctx, d_output):
        # TODO: Implement for Task 1.4.
        a = ctx.saved_values
        return(operators.relu_back(a , d_output) , d_output)
        raise NotImplementedError('Need to implement for Task 1.4')
...
class Exp(ScalarFunction):
    ...
    def backward(ctx, d_output):
        # TODO: Implement for Task 1.4.
        a = ctx.saved_values
        return (operators.exp(a) * d_output , d_output)
        raise NotImplementedError('Need to implement for Task 1.4')
